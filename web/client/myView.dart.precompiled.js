...
InputElement: {"": "HtmlElement;name=,value=", "%": "HTMLInputElement"},
...
main: function() {
  var t1, blogUrl, t2;
  t1 = document.querySelector("#btn-to-blog");
  t1.toString;
  blogUrl = new W._ElementAttributeMap(t1)._element.getAttribute("data-link");
  t1 = document.querySelector("#btn-to-blog");
  t1.toString;
  t1 = new W._ElementEventStreamImpl(t1, C.EventStreamProvider_click._eventType, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new O.main_closure(blogUrl)), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
},

main_closure: {"": "Closure;blogUrl_0",
  call$1: function(e) {
    J.set$href$x(C.Window_methods.get$location(window), this.blogUrl_0);
  },
  $is_args1: true
}},
1],
...
function dart_precompiled($collectedClasses) {
  ...
  function main_closure(blogUrl_0) {
    this.blogUrl_0 = blogUrl_0;
  }
